...
export default function Navbar() {
    ...
    return (
        <>
            <header className="fixed top-0 left-0 z-50 w-full bg-white/80 backdrop-blur-lg shadow-sm">
            ...
            >
                ...
                <div
                    className={`relative top-0 left-0 h-full w-64 bg-white/90 backdrop-blur-xl shadow-xl transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}
                >
                    ...
                    <nav className="flex flex-col p-4 space-y-2">
                        {navLinks.map((link) => (
                            <Link
                                ...
                                className="text-gray-700 hover:bg-blue-50 hover:text-blue-600 p-3 rounded-md transition-all duration-200 text-lg"
                            >
                                {link.label}
                            </Link>
                        ))}
